...
function Home(){
  return(
    ...
    <nav style={styles.nav}>
      ...
      <Link to="/profile/nandini">Optional Params with value</Link>
...
function App() {
  return(
    ...
    <Routes>
      ...
      {/* Dynamic Params */}
      <Route path="/products/:id" element={<DynamicParamsUseParams/>} />

      {/* Multiple Dynamic Params */}
      <Route path="/users/:userId/orders/:orderId" element={<MultipleDynamicParams/>} />

      {/* Optional Parameters */}
      <Route path="/profile" element={<OptionalParameters/>} />

      {/* Optional Parameters with value*/}
      <Route path="/profile/:username" element={<OptionalParameters/>} />

      {/* Nested Dynamic Routes*/}
      <Route path="/courses/:courseId" element={<NestedDynamicRoutes/>} />
