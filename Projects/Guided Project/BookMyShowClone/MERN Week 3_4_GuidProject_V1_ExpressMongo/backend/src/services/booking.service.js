...
//create Booking
exports.createBooking= async (useId,{showId,seats})=>{
    //1.Get show
    ...
    //6. create booking
    const booking= await Booking.create({userId,showId,seats,totalSeats:seats.length})
    return booking

}

//Get user bookings
exports.getUserBookings = async (useId)=>{
...
//cancel booking
exports.createBooking= async (bookingId,userId)=>{
